...
export const Gallery = () => {
    return(
        <main className='flex flex-col items-center justify-start w-full h-full bg-white rounded-2xl space-y-4'>
            <container className="grid grid-cols-2 gap-2 items-center justify-center h-[600px] w-full rounded-2xl lg:hidden">
            ...
            <container className="hidden lg:flex flex-row items-center justify-center h-[600px] w-full rounded-2xl space-x-2">
                <container className="flex w-1/2 h-full">
                    <div className='w-full h-full bg-[url("https://imagenes.20minutos.es/uploads/imagenes/2024/05/15/una-imagen-creada-por-la-herramienta-imagen-3-de-google-1.jpeg")] bg-cover bg-center rounded-2xl'/>
                </container>
                

                <container className="flex w-1/2 h-full space-x-2">
